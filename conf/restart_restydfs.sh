...
# start
${SUDO} ${PATH_FASTDFS_BIN}/fdfs_trackerd ${PATH_FASTDFS_CONF}/tracker.conf start
${SUDO} ${PATH_FASTDFS_BIN}/fdfs_storaged ${PATH_FASTDFS_CONF}/storage.conf start
${SUDO} ${PATH_NGINX_BIN}/nginx
